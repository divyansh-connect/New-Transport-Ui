...
export const DriverProvider = ({ children }) => {
  ...
  const formatUser = (u) => {
    ...
    return {
      ...
      vehicleType: u.serviceType ? u.serviceType.name : (displayTypes[u.role] || 'Visitor'),
      vehicleModel: u.serviceType ? u.serviceType.name : (defaultModels[u.role] || 'Guest Access'),
      ...
      type: u.serviceType?.slug || (u.role === 'oil' ? 'oil' : u.role),
      latitude: u.latitude,
